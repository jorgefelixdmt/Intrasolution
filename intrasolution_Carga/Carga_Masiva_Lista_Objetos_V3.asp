        ...
        <div style="position:absolute; top:500; left:50%;"><img id="waiting" width="50" height="50" src="cargando.gif" hidden /></div> 
            <div class="row justify-content-center round">
                <div class="col-lg-10 col-md-12 ">  
                    <form Name="frmCargos" Action="Carga_Masiva_Lista_Objetos_V3.asp" Method="POST"  ENCTYPE="multipart/form-data">
                        ...
                        <div class="card shadow card-1">
                            <div class="card-header titulo">
                                CARGA MASIVA: Objetos Modificados
                            </div>
...
Sub CargaTablaTemporal()
    ...
    if ExtFile = "XLS" then
        ...
        wSQL1 = "set dateformat dmy insert into pa_carga_lista_objetos_detalle(categoria_objeto,tipo_objeto,nombre_objeto,cliente,codigo_is_incidente,tipo_cambio,comentario,comentario_cabecera,fecha_objeto,fb_uea_pe_id,estado,created,created_by,is_deleted, pa_carga_lista_objetos_id)"
            ...
            End If
	            ...
	            For i = 1 to NumCampos 'Cargo cada columna en la variable
                        If Not isNull(objRs(i-1))  Then
                            If i = 9 Then 'Se agrego replace para evitar comillas simples en comentario
