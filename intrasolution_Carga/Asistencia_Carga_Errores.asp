...
'Response.Write "<tr><td>Registro</td><td>dni_empleado</td><td>area_texto</td><td>cargo_texto</td><td>rol_capacitacion_texto</td><td>nota</td><td>condicion</td><td>Columnas con Errores</td></tr>"
Response.Write "<tr><td>Registro</td><td>dni_empleado</td><td>nombre_completo</td><td>nota</td><td>condicion</td><td>Columnas con Errores</td></tr>"
...
Do While not wRsConsulta.EOF
    ...
    'Response.Write "<td>" &  wRsConsulta("area_texto") & "</td>"
    'Response.Write "<td>" &  wRsConsulta("cargo_texto") & "</td>"
    'Response.Write "<td>" &  wRsConsulta("rol_capacitacion_texto") & "</td>"
    Response.Write "<td>" &  wRsConsulta("nota") & "</td>"
    Response.Write "<td>" &  wRsConsulta("condicion") & "</td>"
