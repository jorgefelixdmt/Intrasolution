...
if not isObject(oConn) then
    ...
    strConnQuery = "Provider=SQLOLEDB;Data Source=192.168.1.190\dev2016;Initial Catalog=intrasolution_desarrollo;User ID=sa;Password=dominiotech" 'Application(wEmpresa)
...
<body>
    ...
    <form Name="frmCargos" Action="index.asp" Method="POST"  ENCTYPE="multipart/form-data">
        <div class="form">      
            ...
            <input TYPE="file" name="file" id="entry_value" SIZE="44%" class=txtcombo ref="fileInput" onchange="getFileName()">
            <!--input TYPE="file" name="file" id="entry_value" SIZE="44%" class=txtcombo ref="fileInput"-->
            <div>
                Arrastre su archivo aqu&iacute; para cargarlo.
                <button class="btn bg-color-dblue btn-primary ">Buscar</button>
    ...
    <div class="divLoader">
        ...
        <input type="button" value="boton que activa el recorrido del excel" onclick="EjecutaAccion('Load')">
...
<script type="text/javascript">
    /*function EjecutaAccion(Accion) {
        ...
        if (Accion == "Load") {
            ...
            //caundo se temina de leer todas las filas del excel hacer que Accion sea diferente de Load asi se quita esa animacion de carga
