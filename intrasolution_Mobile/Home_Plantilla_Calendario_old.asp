...
'
' 21/08/2019                Valky Salinas              Se agregó la funcionalidad de poder agregar archivos CSS por portlet.
'
' ******************************************************************************************************************************************************
' 
'
  ...
  beforeDraw: function (chart) {
    ...
    window.onload = function() {
        ...
        <%If UCASE(oRsPortlet("Tipo"))="DATATABLE" then%>        
				   load_<%=oRsPortlet("codigo")%>()
        <%End If%>
        <% 'Response.write UCASE(oRsPortlet("Tipo")) & "Hola"
        'response.end
...
<div style=" width: 100%; padding-left: 1.5%; padding-right: 1.5%;">	
    ...
    <div class="panel panel-info" id="cabecera-anio">
              <div class="panel-heading" >
                <form id="frm_Home" class="form-horizontal form-inline text-right" method="post" action="Home_Plantilla_Calendario.asp">
