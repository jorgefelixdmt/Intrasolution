...
<div style=" width: 100%;">     	
    <div class="panel panel-info" id="cabecera-anio">
              <div class="panel-heading" >
                <form id="frm_Home" class="form-horizontal" method="post" action="Home_Plantilla_v2.asp">
                  ...
                  <div class="col-xs-4" id="opc-rango">
                    ...
                    <div class="col-xs-4">
                      ...
                      <label class="control-label text-left text-white col-xs-1" style="padding: 8px 0" for="Anno">A&ntilde;o:&nbsp;</label>
    ...
    <%End if%>
      ...
      <div class="Chart_Inside" >
	   ...
	   <%if UCASE(oRsPortlet("tipo")) = "DYN_HCHART"  then %>
						...
						<div id="div_<%=oRsPortlet("codigo")%>" class="panel-body" style="height:<%=oRsPortlet("altura")%>;position: relative;overflow: hidden;">
                            <div data-mcs-theme="dark-thick"  >
