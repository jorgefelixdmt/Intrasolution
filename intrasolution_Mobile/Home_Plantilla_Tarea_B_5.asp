...
' ******************************************************************************************************************************************************
' Nombre: Home_Plantilla_Tarea_B_5.asp
' Fecha Creación: ---
' Autor: Manuel Perez
    ...
    <% NL = chr(13) & chr(10)
       ...
       Do While Not oRsPortlet.Eof
            if oRsPortlet("file_js") <> "" then
                  ...
                  Response.write "<script type='text/javascript' src='./js/" & file_js & wConector & "Empresa=" & wEmpresa & "&Id_Unidad=" & wId_Unidad & "&Id_Usuario=" & wId_Usuario  & "&Anno=" & wAnno &  "&Codigo=" & oRsPortlet("codigo") & "'></script>" & NL
            End if
            oRsPortlet.MoveNext
        Loop
        %>
...
<div style=" width: 100%; padding-left: 1.5%; padding-right: 1.5%;">	
    ...
    <div class="panel panel-info">
              <div class="panel-heading" >
                <form id="frm_Home" class="form-horizontal form-inline text-right" method="post" action="Home_Plantilla_Tarea2.asp">
...
%>
    ...
    <%End if%>
       ...
       <%if UCASE(oRsPortlet("tipo")) = "TABLE" then %>
		<div class="contenido-left" data-mcs-theme="dark-thick" style="height:<%=oRsPortlet("altura")%>" >
	   <%
