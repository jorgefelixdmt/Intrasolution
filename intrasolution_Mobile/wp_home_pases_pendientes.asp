...
<%
	...
	wSQL = "pr_inc_info_pases_pendientes " & wId_Usuario  
	...
	wQA = wRsHome_Inc("qa")
  wDom = wRsHome_Inc("dominiotech")
	wProd = wRsHome_Inc("produccion")
	wCli = wRsHome_Inc("cliente")
...
<!-- CUADRO TRABAJADORES -->
		...
		<div class="info-box-body text-muted">
			  ...
			  <div class="txt-white">Pases Pendientes</div>
			  <!--div class="ft-1 mdl-color-text--grey-300 texto"><%=wQA%> Pases en QA</!--div-->
			  <!--div class="ft-1 mdl-color-text--grey-300 texto"><%=wProd%> Pases en Producción (Por Confirmar)</!--div-->
        <div class="ft-1 mdl-color-text--grey-300 texto"><%=wDom%> Pases en Dominiotech</div>
        <div class="ft-1 mdl-color-text--grey-300 texto"><%=wCli%> Pases en Cliente</div>
		</div>
          <!-- /top tiles -->
