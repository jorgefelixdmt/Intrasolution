...
<%
    ...
    wSQL = "pr_pa_pend_tabla " & wCliente & ",'" & inicio & "','" & fin & "'"
	...
	if not wRs.EOF then
		Do Until wRs.EOF
			...
			wConfig = wConfig & "	  ""descripcion"" : """ & wRs("descripcion") & """," & NL
			wConfig = wConfig & "	  ""codigo_jira"" : """ & wRs("codigo_jira") & """," & NL
			wConfig = wConfig & "   ""fecha"" : """ & wRs("fecha") & """," & NL
			wConfig = wConfig & "	  ""estado"" : """ & wRs("estado") & """," & NL
