...
wEmpresa = "eco2biz_Engie_indicadores"
'wFlagAutenticacion = 0
'wPaginaComprueba = "is/comprueba.asp"
...
<html lang="es">
  <head>
    ...
    <title>eco2biz: Software de Gestión Ambiental</title>
...
<h5 class="panel-title"><i class="fa fa-spinner fa-spin"></i> &nbsp;&nbsp;Eco2biz : Software de Gestión Ambiental</h5>
</div> <!-- fin titulo -->
            ...
            <div class="col-lg-12">
                       ...
                       <div class="col-xs-12 col-sm-12  col-md-12 col-lg-8"> <!-- usuario password -->
                            <div>
                              ...
                              <div class="form-group form line">
                                ...
                                <form action="validaLogin.asp"  name="FrmDefault">
              ...
              <div class="panel-heading"> <!-- texto pie color verde -->
                <h6 class="panel-title text-center">eco2biz-Sistema de Gestión Ambiental </h6>
                 <h6 class="panel-title text-center">Derechos Reservados</h6>
                 <h6 class="panel-title text-center">ECO SIGMA</h6>
